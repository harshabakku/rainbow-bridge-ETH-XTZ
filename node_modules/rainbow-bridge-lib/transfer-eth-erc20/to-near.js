...
//const { ethOnTezosClientContract } = require('../eth-on-near-client')
...
class TransferETHERC20ToNear {
  ...
  static async waitBlockSafe({
    ...
    while (true) {
      ...
      if (!is_safe) {
        const delay = 10
        console.log(
          `Eth Client contract on Tezos is currently at block ${last_block_number}. Waiting for block ${ethTxblockNumber} to be confirmed. Sleeping for ${delay} sec.`
        )
  ...
  static async deposit({
    ...
    try {
      ...
      // console.log(proof_locker)
       ...
       const txHash = await tezosFA2TokenContract.methods.decentralised_mint(new_owner_id, amount ,'ERC-20-FA2',tokenId).send()
       console.log(txHash)
  ...
  static async execute(command) {
    ...
    //Todo: remove hardcodings connecting all config params to RainbowConfig 
