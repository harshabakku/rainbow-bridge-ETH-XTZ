...
class Tezos2EthRelay {
  ...
  async runInternal(submitInvalidBlock) {
    ...
    const minDelay = Number(RainbowConfig.getParam('tezos2eth-relay-min-delay'))
    const maxDelay = Number(RainbowConfig.getParam('tezos2eth-relay-max-delay'))
    const errorDelay = Number(RainbowConfig.getParam('tezos2eth-relay-error-delay'))
