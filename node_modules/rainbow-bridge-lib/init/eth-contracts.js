...
class EthContractInitializer {
  async execute(contractName, args, gas) {
    ...
    try {
      ...
      console.log("local eth-node-url: " + RainbowConfig.getParam('eth-node-url'));
...
class InitEthLocker {
  static async execute() {
    ...
    RainbowConfig.setParam('eth-prover-address','0x6006774CeB7946816a8A19F5111b3F415C47De5E' );
    console.log("eth prover address " + RainbowConfig.getParam('eth-prover-address'));
