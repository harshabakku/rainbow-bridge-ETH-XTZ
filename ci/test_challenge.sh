...
sleep 30
node index.js stop tezos2eth-relay
node index.js DANGER submit_invalid_tezos_block
sleep 30
node index.js start tezos2eth-relay
...
node index.js transfer-eth-erc20-from-tezos --amount 1 --tezos-sender-account tez_bridge_eth_on_tezos_prover \
