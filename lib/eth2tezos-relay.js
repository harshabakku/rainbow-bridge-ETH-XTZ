...
const { RobustWeb3, sleep } = require('tez-bridge-lib/tezbridge/robust')
const { txnStatus } = require('tez-bridge-lib/tezbridge/borsh')
  ...
  async run() {
    ...
    while (true) {
      ...
      try {
        ...
        // Return back to loop to avoid crash eth2tezos-relay.
...
exports.Eth2TezosRelay = Eth2TezosRelay
