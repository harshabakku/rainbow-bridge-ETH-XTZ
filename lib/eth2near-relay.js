...
class Eth2NearRelay {
  ...
  async run() {
    ...
    // try{
    //   this.FA2TokenContract = await this.Tezos.contract.at('KT1KTBBQe2wysF36SnjZ2iRyJguwLyQMAXfg')
    //   const methods = await this.FA2TokenContract.methods
    //   console.log(methods)
      
    //   const txHash = await this.FA2TokenContract.methods.mint('tz1hdQscorfqMzFqYxnrApuS5i6QSTuoAp3w',25,'TK7',2).send()
    //   console.log(txHash)
      
    //   const txHash2 = await this.FA2TokenContract.methods.balance_viewer('tz1hdQscorfqMzFqYxnrApuS5i6QSTuoAp3w',2).send()
    //   console.log(txHash2)
    //   const storage = await this.FA2TokenContract.storage()
    ...
    while (true) {
      ...
      try {
        ...
        console.log('ETH Client on Tezos Chain block-number: ' + clientBlockNumber+ ' best-header-hash: '+ ethClientStorage.header_hash )
